...
!function(e, t) {
    ...
    var o = function() {
      ...
      , s = function(e) {
        ...
        r.prototype.renderSegHtml = function(e, r) {
            var i, n, o, s = this.context.view, a = e.eventRange, l = a.def, d = a.ui, c = l.allDay, h = s.computeEventDraggable(l, d), u = e.isStart && s.computeEventStartResizable(l, d), p = e.isEnd && s.computeEventEndResizable(l, d), f = this.getSegClasses(e, h, u || p, r), g = t.cssToStr(this.getSkinCss(d));
            if (f.unshift("fc-time-grid-event"),
        ...
        r.prototype.computeSegHorizontals = function(e) {
            ...
            if (function(e) {
                ...
                for (t = 0; t < e.length; t++) {
                    for (r = e[t],
                    i = 0; i < n.length && l(r, n[i]).length; i++)
                        ;
                    r.level = i,
                    (n[i] || (n[i] = [])).push(r)
                }
        ...
        r.prototype.computeSegForwardBack = function(e, t, r) {
            ...
            if (void 0 === e.forwardCoord)
                for (n.length ? (this.sortForwardSegs(n),
                this.computeSegForwardBack(n[0], t + 1, r),
                e.forwardCoord = n[0].backwardCoord) : e.forwardCoord = 1,
        ...
        r.prototype.generateSegCss = function(e) {
            var t, r, i = this.context.options.slotEventOverlap, n = e.backwardCoord, o = e.forwardCoord, s = this.timeGrid.generateSegVerticalCss(e), a = this.timeGrid.isRtl;
            return i && (o = Math.min(1, n + 2 * (o - n))),
            a ? (t = 1 - o,
            r = n) : (t = n,
            r = 1 - o),
            s.zIndex = e.level + 1,
    ...
    function d(e) {
        ...
        return r.forwardPressure = e.forwardPressure,
    ...
    var c = function(e) {
      ...
      , h = function(e) {
        ...
        t.prototype.attachSegs = function(e, t) {
            ...
            return "bgEvent" === e ? r = i.bgContainerEls : "businessHours" === e ? r = i.businessContainerEls : "highlight" === e && (r = i.highlightContainerEls),
      ...
      , p = function(e) {
        function i(r, i, n) {
            ...
            return o.renderBusinessHours = t.memoizeRendering(l.renderSegs.bind(l, "businessHours"), l.unrender.bind(l, "businessHours"), [d]),
            o.renderDateSelection = t.memoizeRendering(o._renderDateSelection, o._unrenderDateSelection, [d]),
            o.renderFgEvents = t.memoizeRendering(a.renderSegs.bind(a), a.unrender.bind(a), [d]),
            o.renderBgEvents = t.memoizeRendering(l.renderSegs.bind(l, "bgEvent"), l.unrender.bind(l, "bgEvent"), [d]),
            o.renderEventSelection = t.memoizeRendering(a.selectByInstanceId.bind(a), a.unselectByInstanceId.bind(a), [o.renderFgEvents]),
            o.renderEventDrag = t.memoizeRendering(o._renderEventDrag, o._unrenderEventDrag, [d]),
            o.renderEventResize = t.memoizeRendering(o._renderEventResize, o._unrenderEventResize, [d]),
            o.processOptions(),
            i.innerHTML = '<div class="fc-bg"></div><div class="fc-slats"></div><hr class="fc-divider ' + o.theme.getClass("widgetHeader") + '" style="display:none" />',
        ...
        i.prototype.processOptions = function() {
            ...
            null === (e = t.wholeDivideDurations(i, n)) && (n = i,
            e = 1),
            this.slotDuration = i,
            this.snapDuration = n,
            this.snapsPerSlot = e,
        ...
        i.prototype.renderSlatRowHtml = function(e) {
            for (var r, i, n, o = this.dateEnv, s = this.theme, a = this.isRtl, l = "", d = t.startOfDay(e.renderRange.start), c = e.minTime, h = t.createDuration(0); t.asRoughMs(c) < t.asRoughMs(e.maxTime); )
                r = o.add(d, c),
                i = null !== t.wholeDivideDurations(h, this.labelInterval),
                n = '<td class="fc-axis fc-time ' + s.getClass("widgetContent") + '">' + (i ? "<span>" + t.htmlEscape(o.format(r, this.labelFormat)) + "</span>" : "") + "</td>",
                l += '<tr data-time="' + t.formatIsoTimeString(r) + '"' + (i ? "" : ' class="fc-minor"') + ">" + (a ? "" : n) + '<td class="' + s.getClass("widgetContent") + '"></td>' + (a ? n : "") + "</tr>",
        ...
        i.prototype.renderContentSkeleton = function() {
            ...
            this.isRtl && (this.colContainerEls.reverse(),
        ...
        i.prototype.computeDateTop = function(e, r) {
            return r || (r = t.startOfDay(e)),
            this.computeTimeTop(t.createDuration(e.valueOf() - r.valueOf()))
        }
        ,
        i.prototype.computeTimeTop = function(e) {
            var r, i, n = this.slatEls.length, o = this.props.dateProfile, s = (e.milliseconds - t.asRoughMs(o.minTime)) / t.asRoughMs(this.slotDuration);
        ...
        i.prototype._renderEventDrag = function(e) {
            ...
            e.isEvent ? this.mirrorRenderer.renderSegs(e.segs, {
                isDragging: !0,
      ...
      , m = function(e) {
        function i(i, n, o, s) {
            ...
            a.renderHeadIntroHtml = function() {
                var e, r = a, i = r.theme, n = r.dateEnv, o = a.props.dateProfile.renderRange, s = t.diffDays(o.start, o.end);
                return a.opt("weekNumbers") ? (e = n.format(o.start, g),
                '<th class="fc-axis fc-week-number ' + i.getClass("widgetHeader") + '" ' + a.axisStyleAttr() + ">" + t.buildGotoAnchorHtml(a, {
                    date: o.start,
                    type: "week",
                    forceOff: s > 1
        ...
        i.prototype.updateBaseSize = function(e, r, i) {
            ...
            this.timeGrid.colEls) {
                ...
                i || (o = this.computeScrollerHeight(r),
    ...
    var y = function(e) {
        function r(r, i) {
            ...
            return n.buildDayRanges = t.memoize(v),
            n.slicer = new S,
            n.timeGrid = i,
    ...
    var S = function(e) {
      ...
      , C = function(e) {
        function i(i, n, o, s) {
            var a = e.call(this, i, n, o, s) || this;
            return a.buildDayTable = t.memoize(E),

...
!function(e, t) {
    ...
    function r(e, n, r) {
        ...
        if (n)
            for (var o in n)
                "style" === o ? y(i, n[o]) : t[o] ? i[o] = n[o] : i.setAttribute(o, n[o]);
        return "string" == typeof r ? i.innerHTML = r : null != r && s(i, r),
        i
    }
    function i(e) {
        e = e.trim();
    ...
    function T(e, t) {
        ...
        return b() && "rtl" === n.direction ? u.scrollbarLeft = s : u.scrollbarRight = s,
    ...
    function J(e, t) {
        ...
        return "string" == typeof e ? function(e) {
            ...
            return null
        }(e) : "object" == typeof e && e ? K(e) : "number" == typeof e ? K(((n = {})[t || "milliseconds"] = e,
        n)) : null
    }
    function K(e) {
        return {
    ...
    function Ye(e) {
        var t, n;
        return function() {
            return t && je(t, arguments) || (t = arguments,
    ...
    function dt(e, t, n, r) {
        var i = {}
          ...
          , l = vt(e.defs, t);
        for (var c in e.defs) {
            "inverse-background" === (S = e.defs[c]).rendering && (S.groupId ? (i[S.groupId] = [],
            a[S.groupId] || (a[S.groupId] = S)) : o[c] = [])
        }
            ...
            for (var p in s) {
                ...
                for (var D = t.state.eventStore, T = 0, w = g.allows; T < w.length; T++) {
                    var R = w[T]
                      ...
                      , M = D.instances[p]
                      , k = void 0;
                    if (k = C ? new ct(t,C,M) : new ct(t,y),
    ...
    function Ft(e, t, n, r) {
        ...
        var s, u = {}, l = function(e, t, n, r, i) {
            ...
            if (o = n.dateEnv.createMarkerMeta(s.start))
                l = o.marker;
            else if (!i)
                return null;
            ...
            u && (d = B(d)),
            l && d <= l && (d = null));
            d ? c = !0 : i || (c = n.opt("forceEventDuration") || !1,
    ...
    function Kt(e, t, n, r) {
        ...
        return t instanceof Date ? i = t : (i = t.date,
        o = t.type,
        a = t.forceOff),
        s = {
            date: u.formatIso(i, {
        ...
        r = r || "",
        !a && e.opt("navLinks") ? "<a" + n + ' data-goto="' + Ot(JSON.stringify(s)) + '">' + r + "</a>" : "<span" + n + ">" + r + "</span>"
    }
    function Qt(e, t, n, r) {
        var i, o, a = n.calendar, s = n.view, u = n.theme, l = n.dateEnv, c = [];
        return Ze(t.activeRange, e) ? (c.push("fc-" + P[e.getUTCDay()]),
        s.opt("monthMode") && l.getMonth(e) !== l.getMonth(t.currentRange.start) && c.push("fc-other-month"),
        o = x(i = B(a.getNow()), 1),
        e < i ? c.push("fc-past") : e >= o ? c.push("fc-future") : (c.push("fc-today"),
        !0 !== r && c.push(u.getClass("today")))) : c.push("fc-disabled-day"),
        c
    }
    function $t(e, t, n) {
        var r = !1
    ...
    var en = function() {
      ...
      , tn = function(e) {
        ...
        t.prototype.on = function(e, t) {
            return nn(this._handlers || (this._handlers = {}), e, t),
            this
        }
        ,
        t.prototype.one = function(e, t) {
            return nn(this._oneHandlers || (this._oneHandlers = {}), e, t),
            this
        }
        ,
        t.prototype.off = function(e, t) {
            return this._handlers && rn(this._handlers, e, t),
    ...
    var pn = function(e) {
        ...
        t.prototype.isDateSelectionValid = function(e) {
            ...
            return !(r && !We(r.validRange, e.range)) && (t = e,
            n = this.calendar,
            wt({
                dateSelection: t
            }, n))
    ...
    var Dn = vn({
        recurringTypes: [{
            parse: function(e, t, n) {
                ...
                if (s) {
                    var l = null;
                    return "duration"in t && (l = J(t.duration),
                    delete t.duration),
                    !l && a.startTime && a.endTime && (r = a.endTime,
                    i = a.startTime,
                    l = {
            ...
            expand: function(e, t, n) {
                ...
                return r ? function(e, t, n, r) {
                    ...
                    for (; o < a; ) {
                        var u = void 0;
                        i && !i[o.getUTCDay()] || (u = t ? r.add(o, t) : o,
                        s.push(u)),
                        o = x(o, 1)
                    }
                    return s
    ...
    var xn = function() {
        ...
        e.prototype.compute = function() {
            ...
            this.computed = Te([Rn, i, r, this.overrides, this.dynamicOverrides], Cn)
        }
        ,
        e
    }()
    ...
    var Bn = function() {
        ...
        e.prototype.createMarkerMeta = function(e) {
            ...
            isNaN(e) || (t = this.timestampToMarker(e))) : Array.isArray(e) && (t = j(e)),
            null !== t && Y(t) ? {
                marker: t,
                isTimeUnspecified: !1,
                forcedTzo: null
    ...
    var Jn = function() {
        ...
        e.prototype.build = function(e, t, n) {
            ...
            n && (d = e,
            e = null != (f = r).start && d < f.start ? f.start : null != f.end && d >= f.end ? new Date(f.end.valueOf() - 1) : d),
        ...
        e.prototype.buildCurrentRangeInfo = function(e, t) {
            ...
            a = r.durationUnit,
            s = this.buildRangeFromDuration(e, t, o, a)) : (n = this.options.dayCount) ? (a = "day",
            s = this.buildRangeFromDayCount(e, t, n)) : (s = this.buildCustomVisibleRange(e)) ? a = i.greatestWholeUnit(s.start, s.end).unit : (a = ne(o = this.getFallbackDuration()).unit,
        ...
        e.prototype.buildRangeFromDuration = function(e, t, n, r) {
            ...
            return c || ((i = this.options.dateIncrement) ? (o = J(i),
            c = te(o) < te(n) ? ne(o, !Q(i)).unit : r) : c = r),
            ee(n) <= 1 && this.isHiddenDay(a) && (a = B(a = this.skipHiddenDays(a, t))),
            d(),
            this.trimHiddenDays(u) || (e = this.skipHiddenDays(e, t),
            d()),
            u
        }
        ,
    ...
    function Kn(e, t, n) {
        for (var r = function(e, t) {
            ...
            return !o || !o.isValid || e && (s = e,
            u = o,
            Ae(s.validRange, u.validRange) && Ae(s.activeRange, u.activeRange) && Ae(s.renderRange, u.renderRange) && $(s.minTime, u.minTime) && $(s.maxTime, u.maxTime)) ? e : o;
            var s, u
    ...
    var pr = function(e) {
        ...
        t.prototype.renderSection = function(e, t) {
            ...
            return t && t.split(" ").forEach(function(e, t) {
                ...
                if (e.split(",").forEach(function(e, t) {
                    ...
                    "title" === e ? (u.push(i("<h2>&nbsp;</h2>")),
                    h = !1) : ((r = d[e]) ? (c = function(e) {
                        r.click && r.click.call(E, e)
                    }
                    ,
                    (v = o.getCustomButtonIconClass(r)) || (v = o.getIconClass(e)) || (g = r.text)) : (s = l[e]) ? (n.viewsWithButtons.push(e),
                    c = function() {
                        a.changeView(e)
                    }
                    ,
                    ...
                    ,
                    (g = f[e]) || (v = o.getIconClass(e)) || (g = p[e])),
                    c && (m = ["fc-" + e + "-button", o.getClass("button")],
                    g ? (y = Ot(g),
                    S = "") : v && (y = "<span class='" + v + "'></span>",
                    S = ' aria-label="' + e + '"'),
                    (E = i('<button type="button" class="' + m.join(" ") + '"' + S + ">" + y + "</button>")).addEventListener("click", c),
                    u.push(E)))
                }),
                u.length > 1) {
      ...
      , hr = function(e) {
        ...
        t.prototype.renderToolbars = function(e, t, n, r, i) {
            ...
            o ? (this.header || (this.header = new pr(this.context,"fc-header-toolbar"),
            u(this.el, this.header.el)),
            this.header.receiveProps(Se({
                layout: o
            }, p))) : this.header && (this.header.destroy(),
            this.header = null),
            a ? (this.footer || (this.footer = new pr(this.context,"fc-footer-toolbar"),
            s(this.el, this.footer.el)),
            this.footer.receiveProps(Se({
                layout: a
            }, p))) : this.footer && (this.footer.destroy(),
            this.footer = null)
        }
        ,
        ...
        t.prototype.queryToolbarsHeight = function() {
            var e = 0;
            return this.header && (e += I(this.header.el)),
    ...
    function vr(e, t) {
        ...
        this.dateEnv.formatRange(n.start, n.end, ot(t.titleFormat || function(e) {
    ...
    var mr = {}
      , Er = function(e) {
        function t(t) {
            ...
            ;
            var r = t.component;
            return n.destroy = O(r.el, "click", r.fgSegSelector + "," + r.bgSegSelector, n.handleSegClick),
            n
        }
        return Ee(t, e),
        t
      ...
      , Sr = function(e) {
        function t(t) {
            ...
            n.handleSegEnter = function(e, t) {
                ht(t) && (t.classList.add("fc-allow-mouse-resize"),
                n.currentSegEl = t,
            ...
            return n.removeHoverListeners = (r = u.el,
    ...
    var Dr = function() {
        ...
        e.prototype.bindHandlers = function() {
            ...
            this.removeNavLinkListener = O(this.el, "click", "a[data-goto]", function(t, n) {
                ...
                "function" == typeof s ? s(i.toDate(o), t) : ("string" == typeof s && (a = s),
                e.zoomTo(o, a))
            }),
        ...
        e.prototype.renderComponent = function(e) {
            ...
            if (!i)
                throw new Error('View type "' + r + '" is not valid');
        ...
        e.prototype.mutateOptions = function(e, t, n, r) {
            ...
            for (var f in e)
                o[f] ? s[f] = e[f] : a[f] = e[f];
            for (var p in a)
                /^(height|contentHeight|aspectRatio)$/.test(p) ? c = !0 : /^(defaultDate|defaultView)$/.test(p) || (d = !0,
                "timeZone" === p && (l = !0));
    ...
    var Mr = function(e) {
        ...
        t.prototype.updateNowIndicator = function() {
            ...
            this.renderNowIndicator(H(this.initialNowDate, (new Date).valueOf() - this.initialNowQueriedMs)),
    ...
    var _r = function() {
        ...
        e.prototype.renderSegs = function(e, t) {
            ...
            i && (n = this.containerElsByType[e] || (this.containerElsByType[e] = [])).push.apply(n, i),
            this.segsByType[e] = r,
        ...
        e.prototype.unrender = function(e) {
            ...
            t && ("bgEvent" === e && this.context.view.triggerWillRemoveSegs(t, !1),
            this.detachSegs(e, t))
        }
        ,
        e.prototype.renderSegEls = function(e, t) {
    ...
    var Br = function(e) {
        function t(t, n) {
            ...
            return n.innerHTML = "",
            n.appendChild(r.el = i('<div class="fc-row ' + r.theme.getClass("headerRow") + '"><table class="' + r.theme.getClass("tableGrid") + '"><thead></thead></table></div>')),
